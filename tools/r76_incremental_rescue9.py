    ...
    for client,host in [('at','translate.google.com'),('dict-chrome-ex','clients5.google.com'),('gtx','translate.googleapis.com')]:
        for attempt in range(4):
            try:
                ...
                # Proper names and international loan words can legitimately stay unchanged.
                # Pack-level validation below still rejects excessive untranslated multi-word UI.
                return out
